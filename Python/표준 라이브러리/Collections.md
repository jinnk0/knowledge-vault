...
[[Python/표준 라이브러리/표준 라이브러리.md|표준 라이브러리]]에 속하는 모듈인 **Collections**는 [[Python/자료형/컬렉션/튜플.md|튜플]], [[Python/자료형/컬렉션/리스트.md|리스트]], [[Python/자료형/컬렉션/딕셔너리.md|딕셔너리]] 같은 기본 [[Python/자료형/컬렉션/컬렉션.md|컬렉션]]을 보완하는 다양한 컨테이너 타입을 제공한다.
